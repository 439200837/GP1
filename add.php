...
<element dir="rtl">
    ...
    <div class="content">
        ...
        <div class="user-details">
           ...
           <input type="text" name="fname" id="fname" onkeyup="ValidateName() " placeholder="ادخل الاسم الاول" dir="rtl" required="required" value="<?php if(isset($_POST['fname'])) { echo htmlentities ($_POST['fname']); }?>">
            <p id="er6" style="color: red;"></p>
          </div>
            
             <div class="input-box">
            <span class="details" dir="rtl">اسم العائلة *</span>
            <input type="text" name="lname" id="lname" onkeyup="ValidateName()" placeholder="ادخل اسم العائلة" dir="rtl" required="required" value="<?php if(isset($_POST['lname'])) { echo htmlentities ($_POST['lname']); }?>">
          ...
          <div class="input-box">
            ...
            <input type="email" name="email" id="email" onkeyup="ValidateEmail()" placeholder="ادخل البريد الإلكتروني" dir="rtl" required="required" value="<?php if(isset($_POST['email'])) { echo htmlentities ($_POST['email']); }?>">
            <p id="er" style="color: red;"></p>
          </div>
         
          <div class="input-box">
            <span class="details" dir="rtl">*رقم الهاتف</span>
            <input type="text"  onkeyup="ValidatePhone()" name="phone" id="phone" placeholder="05XXXXXXXX" dir="rtl" required="required" value="<?php if(isset($_POST['phone'])) { echo htmlentities ($_POST['phone']); }?>">
