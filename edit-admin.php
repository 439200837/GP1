...
$id=$_GET['id'];
 // change title name
echo "<script> document.title=' تعديل معلومات المشرف' </script>";
?>
<element dir="rtl">
<html>
    <head>
    ...
    <meta charset="UTF-8">
    <title class="reg"> تعديل معلومات المشرف</title>
   ...
   <header class="header">
    ...
    <div class="title" dir="rtl">تعديل معلومات المشرف</div>
    <div class="content">
 <?php 
      ...
      <form action="edit-admin.php" method="POST">
        <div class="user-details">
          ...
          <div class="input-box">
            ...
            <input type="text" placeholder="ادخل اسم العائلة" id="lname" onkeyup="ValidateNameMember()"  name="last_name" value="<?= $row['last_name']?>" dir="rtl">
...
if(mysqli_affected_rows($connection) >0){
 echo "<script>
                ...
                Swal.fire({
                     icon: 'success',
                     title: 'تم تعديل معلومات المشرف بنجاح',
                     text: '',
