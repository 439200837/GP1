...
function checkPreferences(program,volunteers){//check if preferences are match with program's preferences
    ...
    newArray.push([volunteers[i]['Vemail_address'],1,volunteers[i]['qualifications'],volunteers[i]['cumlativeRating'],volunteers[i]['numvolunteer'],volunteers[i]['first_name'],volunteers[i]['last_name'],volunteers[i]['gender']]);//I need to add rating 
     ...
     newArray.push([volunteers[i]['Vemail_address'],0,volunteers[i]['qualifications'],volunteers[i]['cumlativeRating'],volunteers[i]['numvolunteer'],volunteers[i]['first_name'],volunteers[i]['last_name'],volunteers[i]['gender']]);  
    }
...
function QuliFiltter(array,program){
 ...
 var Q = [
        {
        qualifications: ["التربية الخاصة","علم النفس","الخدمة الاجتماعية"],
        tag: "تاج الهمم"
        },
        {
        qualifications: ["الطب البشري","الخدمة الاجتماعية","علم النفس","التمريض"],
        tag: "لنكن معهم"
        },
        {
        qualifications: ["علم النفس","الخدمة الاجتماعية"],
        tag: "الوحدة النفسية"
        },
        {
        qualifications: ["علم النفس","الخدمة الاجتماعية","التربية الخاصة","رياض الأطفال"],
        tag: "تاج تنمية انسان"
        },
        ]   
