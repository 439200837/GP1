...
<?php 
        $programCount=10;
        $volunteerCount=10;
        $sqlST='SELECT COUNT(name) as count FROM `program`';
        $resultST= mysqli_query($connection,$sqlST);
                 while($row= mysqli_fetch_assoc($resultST)){
                 $programCount+=$row['count'];
                 }
        $sqlV='SELECT COUNT(first_name) as count FROM `volunteer`';
        $resultV= mysqli_query($connection,$sqlV);
                 while($row= mysqli_fetch_assoc($resultV)){
                 $volunteerCount+=$row['count'];
                 }
        ?>
                ...
                <div class="card card-stats mb-4 mb-xl-0">
                  <div class="card-body">
                    ...
                    <div class="col">
                      ...
                      <span class="h2 font-weight-bold mb-0"><?=$volunteerCount?></span>
                    </div>
                  ...
                  <div class="card-body">
                    ...
                    <div class="col">
                      ...
                      <span class="h2 font-weight-bold mb-0"><?=$programCount?></span>
                    </div>
    ...
    <!-- Page content -->
      <h2 class="mb-5 text-white">حسابنا على تويتر </h2>
    <div id="flockler-embed-180303a59d3012946b88aa0acb0c0c9d"></div>
    <script src="https://plugins.flockler.com/embed/1802f7c9b460463ca2c14640e10622df/180303a59d3012946b88aa0acb0c0c9d" async></script><!-- comment -->
    <h2 class="mb-5 text-white">حسابنا على انستقرام </h2>
    <div id="flockler-embed-18030384f320e0cdd880df834520139c"></div>
<script src="https://plugins.flockler.com/embed/1802f7c9b460463ca2c14640e10622df/18030384f320e0cdd880df834520139c" async></script>
  </div>
<style>
    body{
