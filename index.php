      ...
      <form action="#">
        <div class="user-details">
          ...
          <div class="input-box">
            ...
            <input type="tel" placeholder="ادخل تأكيد كلمة السر" required dir="rtl">
          </div>
                <div class="input-box">
          ...
          <div class="category" >
            ...
            <input type="email" placeholder="ادخل رقم الهاتف" dir="rtl">
          </div>
             <div class="input-box">
   ...
   <option value="handdicaped">أفضل التعامل مع ذوي الاحتياجات الخاصة</option>
     ...
     <input  type="checkbox" id="s2" name="s2" ><span class="skill" >العمل الجماعي</span><br>
      <input type="checkbox" id="s3" name="s3" ><span class="skill" >امكانية العمل تحت الضغط</span><br>
            ...
            <input type="submit" value="تسجيل" class="fbutton">
